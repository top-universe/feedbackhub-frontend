    ...
    <header className={`container-64 py-2 lg:py-8 relative bg-white `}>
      <section className="bg-transparent">
        <div className="w-full flex justify-between items-center">
          ...
          {menuIsOpen ? (
            <button
              className="w-fit p-0 lg:hidden focus:outline-none border-none bg-transparent"
              onClick={closeMenu}
            >
            ...
            <button
              className="w-fit p-2 lg:hidden focus:outline-none border-none bg-transparent"
              onClick={openMenu}
            >
        ...
        <div
          className={`w-full bg-transparent absolute left-0 top-14 flex justify-center backdrop-blur-[5px] overflow-hidden \
        ${
          menuIsOpen ? "max-h-fit p-10 opacity-100" : "p-0 max-h-0 opacity-40"
