  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "fh-md": "0px 4px 6px 0px rgba(31, 41, 55, 0.10), 0px 2px 4px 0px rgba(31, 41, 55, 0.06)",
        "fh-lg": "0px 0px 6px 0px rgba(31, 41, 55, 0.05), 0px 10px 15px 0px rgba(31, 41, 55, 0.10)",
        "fh-xl": "0px 10px 10px 0px rgba(31, 41, 55, 0.04), 0px 20px 25px 0px rgba(31, 41, 55, 0.10)",
